...
export function create(req, res) {
  ...
  let message = new Message({
    ...
    // ,data: 'Some useful data should be here'
  });
  console.log(req.file);
  // console.log('message methods - ', Reflect.ownKeys(message));

  // message.addAttachment("file.txt", new Buffer('test'))
  message.addAttachment(req.file.originalname, req.file.buffer, req.file.mimetype)
    .then(function(doc) {
